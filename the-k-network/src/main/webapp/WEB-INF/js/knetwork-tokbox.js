	...
	*/
	function echoCancellationModeChangedHandler(event) {
		switch(publisher.getEchoCancellationMode()) {
			case "fullDuplex":
				setPushToTalk(false);
				document.getElementById("call-status").innerHTML = "Active - Connected to Audio";
				break;
			case "none":
				document.getElementById("call-status").innerHTML = "Active - Connected to Audio";
				setPushToTalk(true);
	...
	*/
	...
	function subscribeToStream(stream) {
		...
		var subscriberProps = {width: subscriber_width[120],
				height: subscriber_height[90],
				subscribeToAudio: !pushToTalk,
